...
'''
if Player.check_shield():
    monster_data = {
        'squid': {'health': 100, 'exp': 100, 'damage': 1000, 'attack_type': 'slash', 'attack_sound': slash_sound_path, 'speed': 150, 'resistance': 3, 'attack_radius': 80, 'notice_radius': 360},
...
monster_data = {
        'squid': {'health': 100, 'exp': 100, 'damage': 10, 'attack_type': 'slash', 'attack_sound': slash_sound_path, 'speed': 150, 'resistance': 3, 'attack_radius': 80, 'notice_radius': 360},
        'raccoon': {'health': 300, 'exp': 250, 'damage': 40, 'attack_type': 'claw',  'attack_sound': claw_sound_path, 'speed': 100, 'resistance': 3, 'attack_radius': 120, 'notice_radius': 400},
        'spirit': {'health': 100, 'exp': 110, 'damage': 8, 'attack_type': 'thunder', 'attack_sound': fireball_sound_path, 'speed': 200, 'resistance': 3, 'attack_radius': 60, 'notice_radius': 350},
        'bamboo': {'health': 70, 'exp': 120, 'damage': 8, 'attack_type': 'leaf_attack', 'attack_sound': slash_sound_path, 'speed': 150, 'resistance': 3, 'attack_radius': 50, 'notice_radius': 300}}
